...
* **2 x 18650 Batteries:** Provides roughly 7.4V enough to be stepped down but also stable enough to power the DC motors.
* **LM2596S:** Buck converter module used to step down voltage for the 3.3v mcu.
